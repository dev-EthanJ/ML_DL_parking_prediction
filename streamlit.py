...
# Predicting 페이지
    ...
    with forcasting_container:
        ...
        with tab3:
                ...
                # 첫번째 행
                r1_col1, r1_col2, r1_col3 = st.columns(3)
                총세대수3 = r1_col1.slider("총세대수_xgb", 26, 2568)
                전용면적3 = r1_col2.slider("전용면적_xgb", 14.1, 583.4)
                전용면적별세대수3 = r1_col3.slider("전용면적별세대수_xgb", 1, 1865)
                # 두번째 행
                r2_col1, r2_col2, r2_col3 = st.columns(3)
                공가수3 = r2_col1.slider("공가수_xgb",0,55)
                지하철_xgb_option3 = (0, 1, 2, 3)
                지하철3 = r2_col2.selectbox("지하철_xgb", 지하철_xgb_option3)
                버스3 = r2_col3.slider("버스_xgb", 0,20)
                # 세번째 행
                r3_col1, r3_col2, r3_col3 = st.columns(3)
