...
# Visualizing 페이지
    ...
    with visualizing_container:
       ...
       '공급유형_비율', '지역_비율'],
        ...
        fig.update_layout({"title": {"text": "지역별 세대(성별/연령)","x": 0.5, "y": 0.9, # y 축 기준 타이틀 위치
                                     "font": {"size": 20 # 타이틀 글씨 크기}},"showlegend": True,"xaxis": 
                                              {"title": "지역","showticklabels": True, "dtick": 1 # x 축 간격 범위},
